        ...
        <div class="col-md-8 offset-md-2">
            ...
            <form method="POST" id="create-product-form" onsubmit="storeProduct(event);">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="product_description" name="product_description" rows="3" required>Test Description</textarea>
                </div>
                <div class="form-group">
                    <label for="product_price">Product Price</label>
                    <input type="number" step="0.01" class="form-control" id="product_price" name="product_price" value="10.00" required>
                </div>
